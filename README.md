## rb1_base_common (melodic) - 1.12.0-1

The packages in the `rb1_base_common` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic rb1_base_common --edit` on `Thu, 17 Sep 2020 07:07:48 -0000`
...
## rb1_base_common (kinetic) - 2.0.0-2

The packages in the `rb1_base_common` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release rb1_base_common --rosdistro kinetic` on `Thu, 03 Sep 2020 10:12:56 -0000`
...
## rb1_base_common (kinetic) - 2.0.0-1
